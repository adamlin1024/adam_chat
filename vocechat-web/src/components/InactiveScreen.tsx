...
const InactiveScreen: FC<Props> = () => {
  ...
  return (
    <div className="w-screen h-screen bg-bg-surface flex-center text-4xl font-bold">
      <div className="flex flex-col items-center text-center gap-2">
        <h1 className="text-lg md:text-4xl text-fg-primary font-bold">{t("inactive.title")}</h1>
        <p className="text-fg-secondary text-xs md:text-sm font-semibold">{t("inactive.desc")}</p>
