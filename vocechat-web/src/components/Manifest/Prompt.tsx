...
const Prompt: FC<Props> = ({ handleInstall, closePrompt }) => {
  ...
  return (
    <Modal mask={false}>
      <div className="relative pointer-events-auto mt-4 w-[406px] p-4 rounded-md bg-bg-app shadow-md flex flex-col gap-3">
        <IconClose className="absolute top-4 right-4 cursor-pointer" onClick={closePrompt} />
        <div className="flex flex-col gap-4 text-fg-body">
