            ...
            <Tooltip tip={t("pin")} placement="left">
              ...
              >
                <li className={`${toolClass}`}>
                  ...
                  <IconPin className="fill-fg-subtle hover:fill-fg-secondary transition-colors" />
                </li>
              </Tippy>
            </Tooltip>
            ...
            {canViewMembers && (
              <li className={`${toolClass}`} onClick={toggleMembersVisible}>
                <Tooltip tip={t("channel_members")} placement="left">
                  <IconPeople className={visibleAside == "members" ? "fill-fg-primary" : "fill-fg-subtle hover:fill-fg-secondary transition-colors"} />
                </Tooltip>
              </li>
            )}
          </ul>
