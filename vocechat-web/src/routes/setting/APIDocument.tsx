...
const APIDocument = () => {
  ...
  return (
    <section className="flex flex-col justify-start items-start gap-4">
      <div className="font-semibold text-fg-primary">{t("api_doc.desc")}</div>
      <div className="flex flex-col gap-2 w-full">
        <h2 className="text-fg-primary text-lg font-semibold flex gap-1">
          {t("api_doc.access")}
          <a
            href={APIUrl}
            target="_blank"
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h3 className="text-fg-primary ">{t("api_doc.step_1")}</h3>
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-fg-primary flex flex-col items-start gap-2">
              {t("api_doc.step_2")}{" "}
              <span className="text-fg-primary text-xs">
                ({t("api_doc.step_2_desc")})
              </span>
            </h3>
            <div className="flex flex-col border border-solid border-online bg-online/15 rounded-md p-2 w-fit break-words text-sm relative">
            ...
            <img
              className="border border-solid rounded-md border-border shadow-lg md:w-[85%]"
              src="https://s.voce.chat/web_client/assets/img/api.doc.step2.jpg"
              alt="step 2"
            />
          </div>
          <div className="flex flex-col gap-2">
            <h3 className="text-fg-primary flex items-center gap-2">
              {t("api_doc.last")}
            </h3>
            <img
              className="border border-solid rounded-md border-border shadow-lg md:w-[85%]"
