...
- icon 14×14, `color: #52525b`, stroke 1.4px
- 右側可有 mono shortcut：`font-mono 10px / #3f3f46`（例：`⌘E`）
...
```html
<ul class="min-w-[180px] rounded-lg border border-border bg-bg-elevated p-1
           shadow-[0_8px_24px_#00000066]">
  <li class="flex items-center gap-2 rounded-sm px-2.5 py-1.5 text-[12px]
             text-fg-secondary hover:bg-bg-surface hover:text-fg-primary">
    <ReplyIcon class="h-3.5 w-3.5 text-fg-subtle" />
    <span class="flex-1">回覆</span>
    <span class="font-mono text-[10px] text-fg-disabled">R</span>
  </li>
  <!-- separator -->
