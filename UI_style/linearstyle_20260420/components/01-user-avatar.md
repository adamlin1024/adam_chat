...
- 容器：32×32px，`border-radius: 50%`
- 背景：漸層 `linear-gradient(135deg, #5eead4, #06b6d4)`
- 文字：縮寫 1 字母，`Inter 700 / 13px`，`color: #042f2e`
- 狀態圓點：9×9px，`#4ade80`，位於右下 -2/-2，2px 邊框 `#08090b`
- 外層點擊區：40×40px（hit target）
...
```html
<button class="relative flex h-8 w-8 items-center justify-center rounded-full
               bg-gradient-to-br from-teal-300 to-cyan-500
               text-[13px] font-bold text-teal-950">
  A
