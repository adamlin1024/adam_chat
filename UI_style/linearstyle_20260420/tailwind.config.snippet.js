...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // 與 tokens.json 對齊（小/緊湊）
        'xs-ds':   ['10.5px', { lineHeight: '1.4' }],  // section label
        'sm-ds':   ['11px',   { lineHeight: '1.5' }],  // timestamp / badge
        'base-ds': ['12.5px', { lineHeight: '1.5' }],  // session name / header
        'body-ds': ['13px',   { lineHeight: '1.55' }], // 訊息正文
        'lg-ds':   ['14px',   { lineHeight: '1.4' }],  // modal title
      },
      ...
      spacing: {
        // Tailwind 預設 spacing 已夠用，這裡只加專案常用的固定寬高
        'icon-bar':     '56px',
        'session-bar':  '232px',
        'chat-header':  '48px',
        'hit-min':      '32px',
