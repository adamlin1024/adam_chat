...
| size | 像素 | 文字大小 | 用於 |
|---|---|---|---|
| `xs` | 24 | 11px | session item 內（僅特殊場景） |
| `sm` | 32 | 12px | session item、header DM、profile mini |
| `md` | 36 | 13px | icon 欄 user avatar / 訊息頭像 |
| `lg` | 40 | 14px | 標準訊息頭像（[3-2]） |
| `xl` | 52 | 18px | profile card / member list |
| `2xl` | 64 | 22px | Profile card 主頭像 |
